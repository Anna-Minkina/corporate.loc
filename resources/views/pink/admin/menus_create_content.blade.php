<div id="content-page" class="content group">
    <div class="hentry group">
        ...
        {!! Form::open([
            'url' => isset($menu->id) ? route('menus.update', ['menu' => $menu->id]) : route('menus.store'),
            'class' => 'contact-form',
            'method' => 'POST',
        ...
        <ul>
            ...
            <li class="text-field">
                ...
                <div class="input-prepend"><span class="add-on"><i class="icon-user"></i></span>
                    {!! Form::text('title', isset($menu->title) ? $menu->title : old('title'), [
            ...
            <div id="accordion">
                ...
                <ul>
                    <li class="text-field">
                        ...
                        <div class="input-prepend"><span class="add-on"><i class="icon-user"></i></span>
                            {!! Form::text('custom_link', isset($menu->path) && $type == 'customLink' ? $menu->path : old('custom_link'), [
                                'placeholder' => 'Введите название страницы',
                            ]) !!}
                        </div>
                    </li>
