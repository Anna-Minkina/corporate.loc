<div id="content-page" class="content group">
    <div class="hentry group">
        ...
        {!! Form::open([
            'url' => isset($user->id) ? route('users.update', ['user' => $user->id]) : route('users.store'),
            'class' => 'contact-form',
            'method' => 'POST',
        ...
        <ul>
            <li class="text-field">
                ...
                <div class="input-prepend"><span class="add-on"><i class="icon-user"></i></span>
                    {!! Form::text('name', isset($user->name) ? $user->name : old('name'), [
            ...
            <li class="text-field">
                ...
                <div class="input-prepend"><span class="add-on"><i class="icon-user"></i></span>
                    {!! Form::text('login', isset($user->login) ? $user->login : old('login'), [
