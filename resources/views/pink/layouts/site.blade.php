...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="72x72"
        href="{{ asset(config('settings.theme')) }}/apple-touch-icon-72x.png" />
    ...
    <link rel="stylesheet" type="text/css" media="all"
        href="{{ asset(config('settings.theme')) }}/css/reset.css" /> <!-- RESET STYLESHEET -->
    <link rel="stylesheet" type="text/css" media="all" href="{{ asset(config('settings.theme')) }}/style.css" />
    <!-- MAIN THEME STYLESHEET -->
    <link rel="stylesheet" id="max-width-1024-css"
        href="{{ asset(config('settings.theme')) }}/css/max-width-1024.css" type="text/css"
        media="screen and (max-width: 1240px)" />
    <link rel="stylesheet" id="max-width-768-css" href="{{ asset(config('settings.theme')) }}/css/max-width-768.css"
        type="text/css" media="screen and (max-width: 987px)" />
    <link rel="stylesheet" id="max-width-480-css" href="{{ asset(config('settings.theme')) }}/css/max-width-480.css"
        type="text/css" media="screen and (max-width: 480px)" />
    <link rel="stylesheet" id="max-width-320-css" href="{{ asset(config('settings.theme')) }}/css/max-width-320.css"
        type="text/css" media="screen and (max-width: 320px)" />

    <!-- CSSs Plugin -->
    <link rel="stylesheet" id="thickbox-css" href="{{ asset(config('settings.theme')) }}/css/thickbox.css"
        type="text/css" media="all" />
    <link rel="stylesheet" id="styles-minified-css"
        href="{{ asset(config('settings.theme')) }}/css/style-minifield.css" type="text/css" media="all" />
    <link rel="stylesheet" id="buttons" href="{{ asset(config('settings.theme')) }}/css/buttons.css"
        type="text/css" media="all" />
    <link rel="stylesheet" id="cache-custom-css" href="{{ asset(config('settings.theme')) }}/css/cache-custom.css"
        type="text/css" media="all" />
    <link rel="stylesheet" id="custom-css" href="{{ asset(config('settings.theme')) }}/css/custom.css"
        type="text/css" media="all" />
    ...
    <script type="text/javascript"
        src="{{ asset(config('settings.theme')) }}/js/layerslider.kreaturamedia.jquery-min.js"></script>
...
<body
    class="no_js responsive {{ Route::currentRouteName() == 'home' || Route::currentRouteName() == 'portfolios.index' || Route::currentRouteName() == 'portfolios.show' ? 'page-template-home-php' : '' }} stretched">
    ...
    <div class="bg-shadow">
        ...
        <div id="wrapper" class="group">
            ...
            <div id="header" class="group">
                ...
                <div class="group inner">
                    ...
                    <div id="logo" class="group">
                        <a href="index.html" title="Pink Rio"><img
                                src="{{ asset(config('settings.theme')) }}/images/logo.png" title="Pink Rio"
                                alt="Pink Rio" /></a>
                    </div>
                    <!-- END LOGO -->
                    ...
                    <div id="sidebar-header" class="group">
                        <div class="widget-first widget yit_text_quote">
                            <blockquote class="text-quote-quote">&#8220;The caterpillar does all the work but the
                                butterfly gets all the publicity.&#8221;</blockquote>
            ...
            <div class="wrap_result"></div>{{--  блок для отображения пользователю, 
            {{--что в данный момент выполняет сайт, потому как отправка инфы асинхронно не видна пользователю  --}}   
