...
@section('content')
    <div id="content-index" class="content group">
        ...
        <div class="error-404-text group">
            <p>We are sorry but the page you are looking for does not exist.<br />You could <a href="index.html">return to
                    the home page</a> or search using the search box below.</p>
